...
function Up { Write-Host "[*] Starting service..." -ForegroundColor Cyan; Invoke-Compose up -d; Write-Host "[OK] Service started." -ForegroundColor Green; Write-Host "[i] Service available at: http://localhost:8001" -ForegroundColor Yellow }
...
function Logs { Write-Host "[*] Showing logs..." -ForegroundColor Cyan; Invoke-Compose logs -f captcha-worker }
